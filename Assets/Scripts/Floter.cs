...
public class Floter : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        _rigidbody.AddForceAtPosition((Physics.gravity/_floaterCount)*2 , transform.position, ForceMode.Acceleration);
        ...
        if (transform.position.y < _waveHieght)
        {
            ...
            _rigidbody.AddForceAtPosition(new Vector3(0f, Mathf.Abs(Physics.gravity.y)*2 * _dislplacmentMultiplier, 0f),transform.position, ForceMode.Acceleration);
